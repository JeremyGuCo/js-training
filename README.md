[![Build Status](https://travis-ci.org/JeremyGuCo/js-training.svg?branch=master)](https://travis-ci.org/JeremyGuCo/js-training)
## Setup
First, [**fork**](https://github.com/JeremyGuCo/js-training/fork?fragment=1) this repository.
